 ...
 * Author: fv
 *
 * Created on April 27, 2018, 10:32 PM
 */
...
namespace fs{
    ...
    class fsWorld : private b2World{
    public:
        fsWorld(fsVec2& vect) : b2World(vect.convertTob2()){}
        virtual ~fsWorld(){}
...
//	void setDebugDraw(b2Draw* debugDraw);
	...
	void drawDebugData(){DrawDebugData();}
...
//	void rayCast(b2RayCastCallback* callback, const b2Vec2& point1, const b2Vec2& point2) const;
	...
	/// The minimum is 1.
	float32 getTreeQuality() const{return GetTreeQuality();}

	/// Change the global gravity vector.
	void setGravity(fsVec2& gravity){SetGravity(gravity.convertTob2());}
	
	/// Get the global gravity vector.
	fsVec2 getGravity() const{return fsVec2(GetGravity());}
	...
	void shiftOrigin(fsVec2& newOrigin){ShiftOrigin(newOrigin.convertTob2());}
